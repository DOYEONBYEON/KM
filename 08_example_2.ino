...
#define _DIST_MIN 100 // minimum distance to be measured (unit: mm) 10cm
#define _DIST_MAX 300 // maximum distance to be measured (unit: mm) 30cm
...
// turn on the LED if the distance is between dist_min and dist_max
  ...
  else if (200 < dist_raw && dist_raw < 300) {
